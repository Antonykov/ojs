...
<head>
    ...
    <link rel="stylesheet" href="/ojs/styles/journal/leftSidebar.css" type="text/css" />

    <link rel="stylesheet" href="/ojs/styles/journal/style.css" type="text/css" />
    <link rel="stylesheet" href="/ojs/styles/journal/sidebar.css" type="text/css" />
    <link rel="stylesheet" href="/ojs/styles/journal/min.css" type="text/css" />
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <script type="text/javascript" src="/ojs/styles/journal/script.js"></script>
    <!--
...
<div class="pkp_structure_page">
    ...
    <div id="header">
        ...
        <div id="social">
            <a href="https://scholar.google.com.ua/citations?user=0iqI-UsAAAAJ&hl=ru"><img src="/ojs/common/social_img/goo_sch.png" onmouseover="this.src='/ojs/common/social_img/goo_sch_blue.png';" onmouseout="this.src='/ojs/common/social_img/goo_sch.png';" title="Google Scholar" alt="Google Scholar" width="16" height="16"></a>&nbsp;&nbsp;
            <a href="https://www.facebook.com/journal.iitta/?ref=tn_tnmn"><img src="/ojs/common/social_img/fb.png" onmouseover="this.src='/ojs/common/social_img/fb_blue.png';" onmouseout="this.src='/ojs/common/social_img/fb.png';" title="Facebook" alt="Facebook" width="16" height="16"></a>&nbsp;&nbsp;
            <a href="https://plus.google.com/u/0/112335705302815713443"><img src="/ojs/common/social_img/google.png" onmouseover="this.src='/ojs/common/social_img/google_blue.png';" onmouseout="this.src='/ojs/common/social_img/google.png';" title="Google +" alt="Google +" width="16" height="16"></a>&nbsp;&nbsp;
            <a href="http://journal.iitta.gov.ua/index.php/itlt/gateway/plugin/WebFeedGatewayPlugin/rss2"><img src="/ojs/common/social_img/rss.png" onmouseover="this.src='/ojs/common/social_img/rss_blue.png';" onmouseout="this.src='/ojs/common/social_img/rss.png';" title="RSS" alt="rss" width="15" height="15"></a>&nbsp;&nbsp;
            <a href="https://twitter.com/journal_itlt"><img src="/ojs/common/social_img/twitter.png" onmouseover="this.src='/ojs/common/social_img/twitter_blue.png';" onmouseout="this.src='/ojs/common/social_img/twitter.png';" title="Twitter" alt="Twitter" height="17"></a>&nbsp;&nbsp;
            <a href="http://journal.iitta.gov.ua/index.php/itlt/pages/view/indexing"><img src="/ojs/common/social_img/index.png" onmouseover="this.src='/ojs/common/social_img/index_blue.png';" onmouseout="this.src='/ojs/common/social_img/index.png';" title="Indexing" alt="Indexing"  height="18"></a>&nbsp;&nbsp;
            <a href="http://journal.iitta.gov.ua/index.php/itlt/pages/view/stat"><img src="/ojs/common/social_img/stat.png" onmouseover="this.src='/ojs/common/social_img/stat_blue.png';" onmouseout="this.src='/ojs/common/social_img/stat.png';" title="Statistic" alt="Statistic"  height="16"></a>&nbsp;&nbsp;
            <a href="http://journal.iitta.gov.ua/index.php/itlt/search"><img src="/ojs/common/social_img/search.png" onmouseover="this.src='/ojs/common/social_img/search_blue.png';" onmouseout="this.src='/ojs/common/social_img/search.png';" title="Search" alt="Search"  height="16"></a>&nbsp;&nbsp;
            <a href="http://journal.iitta.gov.ua/index.php/itlt/about/contact"><img src="/ojs/common/social_img/contacts.png" onmouseover="this.src='/ojs/common/social_img/contacts_blue.png';" onmouseout="this.src='/ojs/common/social_img/contacts.png';" title="Contacts" alt="Contacts" height="15"></a>
        ...
        <div id="navbar" class="clearfix">
            <ul class="menu clearfix">
                ...
                <li id="about"><a href="EditorialBoard.html">Editorial Board</a></li>

                <li id="login"><a href="">Login</a></li>
                <li id="register"><a href="">Register</a></li>
                <li id="search"><a href="">Search</a></li>

                <li id="current"><a href="">Current Issue</a></li>
                <li id="archives"><a href="">Archives</a></li>

                <li id="about"><a href=""}">Ethics Policies</a></li>

                <li id="announcements"><a href="">News</a></li>


                <li class="navItem" id="navItem-0"><a href="">FAQ</a></li>
            </ul>
    ...
    <div id="container">
        <div id="body">
            ...
            <a id="menu2" class="toggle open" href="#leftSidebar">
                <div style="width: 100%; height: 100%; background-color: #36393f; position: relative;">
                    <img  src="/common/right.png" style="width: 90%; position: absolute; margin: auto; left: 0; top: 0; bottom: 0; right: 0;" />
                </div>
            </a>
            ...
            <div id="sidebar">
                <div id="leftSidebar">
                    ...
                    <div class="block" id="sidebarUser">
                        <a id="closebutton" class="toggle close" href="#" style="padding-top: 40px;">
                            <img  src="/common/close.png" style="width: 20px; height: 20px;" />
                        </a>
